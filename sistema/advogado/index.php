              ...
              <div class="rd-navbar-main-element">
                <div class="rd-navbar-nav-wrap">
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item"><a class="rd-nav-link" href="index.php?acao=<?php echo $item6 ?>">Audiencias</a>
                    </li>
                    ...
                    <li class="rd-nav-item"><a class="rd-nav-link" href="index.php?acao=<?php echo $item7 ?>">Movimentação</a>
                    </li>
