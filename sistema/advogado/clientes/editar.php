...
$res = $pdo->prepare("UPDATE clientes set nome = :nome, telefone = :telefone, email = :email, endereco = :endereco, obs = :obs, pessoa = :pessoa where id = :id ");
...
$res->execute();
	...
	$res = $pdo->prepare("UPDATE usuarios set nome = :nome,  email = :email where cpf = :cpf ");
