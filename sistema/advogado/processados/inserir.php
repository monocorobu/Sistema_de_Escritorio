...
if($linhas == 0){
	$res = $pdo->prepare("INSERT into processados (nome, cpf, telefone, email, endereco, advogado, data, obs, pessoa) values (:nome, :cpf, :telefone, :email, :endereco, :advogado, curDate(), :obs, :pessoa) ");
