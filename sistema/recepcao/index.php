...
if (@$_SESSION['nivel_acesso'] != 'Recepcionista' and @$_SESSION['nivel_acesso'] != 'Tesoureiro') {
              ...
              <div class="rd-navbar-main-element">
                <div class="rd-navbar-nav-wrap">
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item"><a class="rd-nav-link" href="index.php?acao=<?php echo $item1 ?>">Home</a></li>
                    ...
                    <?php if (@$_SESSION['nivel_acesso'] == 'Recepcionista') { ?>
